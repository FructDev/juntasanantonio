          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <div className="text-xs mt-0.5" style={{ color: "rgba(255,255,255,0.35)" }}>Barrio San Antonio · San Cristóbal</div>
              </div>
            </div>
            <p className="text-xs leading-relaxed mb-4" style={{ color: "rgba(255,255,255,0.4)" }}>
              ...
              Barrio San Antonio, sector Lava Pie, municipio San Cristóbal, República Dominicana.
            </p>
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center gap-2">
          <p className="text-xs" style={{ color: "rgba(255,255,255,0.25)" }}>
            © 2025 Junta de Vecinos Barrio San Antonio · San Cristóbal, República Dominicana
          </p>
